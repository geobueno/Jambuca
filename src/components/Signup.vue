      ...
      <v-flex xs12 sm6 offset-sm3 mt-3>
        <form @submit.prevent="userSignUp">
          <v-layout column>
            ...
            <v-flex>
              <v-text-field name="email" label="E-mail" id="email" type="email" v-model="email" required></v-text-field>
            </v-flex>
            <v-flex>
...
export default {
  ...
  computed: {
    comparePasswords () {
      return this.password === this.passwordConfirm ? true : 'Senhas não conferem, digite novamente'
    },
    error () {
